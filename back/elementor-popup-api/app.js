...
//TODO-ORTAL USE WEBPACK?
// import {WeatherData, WEATHER_PROXY_HANDLER} from 'weather-data.js';
//todo-ortal move to other files

const APP_ID = '...';
// const DOCUMENT = document; //TODO-ORTAL REMOVE


// ELEMENTS.ELEMENT_SEARCH_BUTTON.addEventListener('click', searchWeather);

function reachServer(){
    const URL = '/elementor-popup/api'; //todo-ortal change
    Http.fetchData(URL)
        .then(responseData => {
            console.log(responseData);
            ELEMENTS.ELEMENT_CONTENT.textContent = responseData.data.content;
            ELEMENTS.ELEMENT_OVERLAY.style.display = 'block';
            ELEMENTS.ELEMENT_MODAL.style.display = 'block';
